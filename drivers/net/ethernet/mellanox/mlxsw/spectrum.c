...
#define MLXSW_SP4_FWREV_MAJOR 32
#define MLXSW_SP4_FWREV_MINOR 2008
#define MLXSW_SP4_FWREV_SUBMINOR 2406

static const struct mlxsw_fw_rev mlxsw_sp4_fw_rev = {
	.major = MLXSW_SP4_FWREV_MAJOR,
	.minor = MLXSW_SP4_FWREV_MINOR,
	.subminor = MLXSW_SP4_FWREV_SUBMINOR,
};

#define MLXSW_SP4_FW_FILENAME \
	"mellanox/mlxsw_spectrum4-" __stringify(MLXSW_SP4_FWREV_MAJOR) \
	"." __stringify(MLXSW_SP4_FWREV_MINOR) \
	"." __stringify(MLXSW_SP4_FWREV_SUBMINOR) ".mfa2"
...
static int mlxsw_sp_port_label_info_get(struct mlxsw_sp *mlxsw_sp,
					u16 local_port, u16 *port_number,
					u16 *split_port_subnumber,
					u8 *slot_index)
{
...
static struct mlxsw_driver mlxsw_sp4_driver = {
	...
	.priv_size			= sizeof(struct mlxsw_sp),
	.fw_req_rev			= &mlxsw_sp4_fw_rev,
	.fw_filename			= MLXSW_SP4_FW_FILENAME,
	.init				= mlxsw_sp4_init,
	.fini				= mlxsw_sp_fini,
	.basic_trap_groups_set		= mlxsw_sp_basic_trap_groups_set,
	.port_split			= mlxsw_sp_port_split,
...
MODULE_FIRMWARE(MLXSW_SP4_FW_FILENAME);
