...
static inline void mlxsw_reg_pllp_unpack(char *payload, u16 *label_port,
					 u16 *split_num, u8 *slot_index)
{
...
/* reg_sbsr_port_page
 * ingress_port_mask[0] is 256*port_page
 * egress_port_mask[0] is 256*port_page
 * Access: Index
 */
