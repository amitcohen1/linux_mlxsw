...
{
	BUILD_BUG_ON_MSG(__ETHTOOL_LINK_MODE_MASK_NBITS != 97,
...
static const struct phy_setting settings[] = {
	...
	PHY_SETTING( 800000, FULL, 800000baseLR8_ER8_FR8_Full	),
	...
	PHY_SETTING( 800000, FULL, 800000baseLR4_ER4_FR4_Full	),
